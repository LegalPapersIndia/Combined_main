      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-screen-2xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-2.5 text-sm">
              {[
                { name: "Contact Us", path: "/iec/contact" },
                { name: "About Us", path: "/iec/about-us" },
                { name: "Refund Policy", path: "/iec/refund-policy" },
                { name: "Terms & Conditions", path: "/iec/term-condition" },
                { name: "Privacy Policy", path: "/iec/privacy-policy" },
                { name: "Disclaimer", path: "/iec/disclaimer" },
              ].map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.path}
